...
private function enviarResultados() {
    ...
    try {
        ...
        echo '  <meta name="description" content="Error al guardar resultados de la prueba de usabilidad">';
        echo '  <title>Error guardando resultados</title>';

        echo '  <link rel="icon" href="../multimedia/imagenes/icon.ico" type="image/x-icon">';
        echo '  <link rel="stylesheet" type="text/css" href="../estilo/estilo.css">';
        echo '  <link rel="stylesheet" type="text/css" href="../estilo/layout.css">';
        echo '</head>';
        echo '<body>';
        echo '<main>';
        echo '  <h1>Error guardando resultados</h1>';
        echo '  <p>' . $msg . '</p>';
        echo '</main>';
        echo '</body>';
        echo '</html>';
